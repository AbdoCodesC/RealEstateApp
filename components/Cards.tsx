  ...
  return (
    ...
    >
      ...
      <Image
        ...
        className="rounded-2xl size-full absolute bottom-0"
      />
      <View className="flex flex-row items-center bg-white/90 px-3 py-1.5 rounded-full absolute right-5 top-5">
